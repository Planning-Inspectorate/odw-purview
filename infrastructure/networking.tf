...
/**
# Commented out because private networking with Purview currently doesn't work with Unified Catalog solution integrations
# https://learn.microsoft.com/en-us/purview/unified-catalog-self-serve-analytics
